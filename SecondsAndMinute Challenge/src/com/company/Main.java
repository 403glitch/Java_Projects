...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getDurationString(3995));
    }
    ...
    public static String getDurationString (int sec){
        ...
        return getDurationString(minutes , remainingsec); // we are returning our value to the first method so that it can print it in hour + "h " + remainingMinutes + "m " + sec + "s" format
    }
